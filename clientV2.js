...
function printRedWhites(){
    ...
    for(let i = 0; i < reds; i++){
        rightColumn.innerHTML += `<button type="button" id = "B${counter}" class = "red ${counter}"></button>`;
        counter++;
    }
    for(let i = 0; i < whites; i++){
        rightColumn.innerHTML += `<button type="button" id = "B${counter}" class = "white ${counter}"></button>`;
        counter++;
    }
